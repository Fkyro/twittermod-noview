...
.field private sink:Lhn2;

.field private socket:Ljava/net/Socket;

.field private source:Ljn2;
...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 10
    :try_start_1
    invoke-static {v1}, Lm33;->D0(Ljava/net/Socket;)Lhyp;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Ljn2;

    .line 11
    invoke-static {v1}, Lm33;->z0(Ljava/net/Socket;)Lmpp;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lhn2;
    :try_end_1
    ...
    invoke-static {p4, p3}, Lahd;->l(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 25
    invoke-static {p1}, Lcqq;->u0(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v5, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Lu9b;)V
    ...
    invoke-virtual {v3, v0, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lu9b;)V
...
.method private final connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 7
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lhn2;

    .line 8
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Ljn2;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    .line 3
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Ljn2;

    invoke-static {v0}, Lahd;->c(Ljava/lang/Object;)V

    .line 4
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lhn2;
    ...
    invoke-direct {v3, v4, p0, v0, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Ljn2;Lhn2;)V
    ...
    invoke-virtual {v5, v6, v7, v8}, Lmcs;->timeout(JLjava/util/concurrent/TimeUnit;)Lmcs;

    .line 7
    invoke-interface {v2}, Lmpp;->timeout()Lmcs;
    ...
    invoke-static {v2, p3, v1}, Lgqq;->E0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {p3, p2}, Lahd;->l(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lpm2;->r2()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-interface {v2}, Lhn2;->m()Lpm2;
...
.method private final startHttp2(I)V
    ...
    .line 2
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Ljn2;
    ...
    invoke-virtual {v4, v0, v5, v1, v2}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Ljn2;Lhn2;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 26
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->source:Ljn2;

    .line 27
    iput-object v12, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lhn2;
...
.method public final isHealthy(Z)Z
    ...
    .line 8
    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->source:Ljn2;
    ...
    .line 14
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->isHealthy(Ljava/net/Socket;Ljn2;)Z
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    .line 7
    invoke-interface {v1}, Lhyp;->timeout()Lmcs;
    ...
    invoke-virtual {v0, v3, v4, v5}, Lmcs;->timeout(JLjava/util/concurrent/TimeUnit;)Lmcs;
    ...
    invoke-direct {v0, p1, p0, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Ljn2;Lhn2;)V
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct {v0, v1, v2, p1}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Ljn2;Lhn2;Lokhttp3/internal/connection/Exchange;)V
