...
.method public final acceptHeader(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v1}, Lahd;->l(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method public final toggleMask(Lpm2$c;[B)V
    .locals 9
    ...
    .line 2
    :cond_0
    iget-object v3, p1, Lpm2$c;->I0:[B

    .line 3
    iget v4, p1, Lpm2$c;->J0:I

    .line 4
    iget v5, p1, Lpm2$c;->K0:I
    ...
    .line 9
    :cond_1
    iget-wide v3, p1, Lpm2$c;->H0:J

    iget-object v5, p1, Lpm2$c;->E0:Lpm2;

    invoke-static {v5}, Lahd;->c(Ljava/lang/Object;)V

    .line 10
    iget-wide v7, v5, Lpm2;->F0:J
    ...
    :goto_2
    invoke-virtual {p1, v3, v4}, Lpm2$c;->b(J)I
