...
# direct methods
.method public constructor <init>(Lhyp;I)V
    .locals 7
...
.method public constructor <init>(Lhyp;II)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Ljn2;
...
.method public synthetic constructor <init>(Lhyp;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    .line 8
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lhyp;II)V
...
.method private final getName(I)Lh23;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Lh23;
...
.method private final readByte()I
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Ljn2;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lh23;

    move-result-object p1

    .line 2
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lh23;
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lh23;Lh23;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lh23;)Lh23;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lh23;Lh23;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lh23;Lh23;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lh23;Lh23;)V
...
.method public final readByteString()Lh23;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Ljn2;

    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(Ljn2;JLhn2;)V
    ...
    invoke-interface {v0, v2, v3}, Ljn2;->b2(J)Lh23;
