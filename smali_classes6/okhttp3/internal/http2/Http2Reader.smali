...
.method public constructor <init>(Ljn2;Z)V
    .locals 7
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ljn2;
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Ljn2;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lhyp;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ljn2;

    invoke-interface {v1}, Ljn2;->readByte()B
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ljn2;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILjn2;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ljn2;
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ljn2;

    invoke-interface {p4}, Ljn2;->readInt()I

    move-result p4

    .line 2
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ljn2;
    ...
    invoke-interface {v0, v1, v2}, Ljn2;->b2(J)Lh23;

    move-result-object v0

    .line 6
    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lh23;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ljn2;

    invoke-interface {p2}, Ljn2;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 13
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ljn2;

    invoke-interface {v3}, Ljn2;->readByte()B
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 4
    invoke-static {p3, p2, p4}, Ls2p;->b(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private final readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, Ljn2;->readInt()I
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 5
    invoke-static {v0, p2}, Lbpf;->G(II)Lubd;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lbpf;->E(Lsbd;I)Lsbd;

    move-result-object p2

    .line 6
    iget v1, p2, Lsbd;->E0:I

    .line 7
    iget v2, p2, Lsbd;->F0:I

    .line 8
    iget p2, p2, Lsbd;->G0:I
    ...
    .line 9
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ljn2;

    invoke-interface {v4}, Ljn2;->readShort()S
    ...
    .line 10
    iget-object v5, p0, Lokhttp3/internal/http2/Http2Reader;->source:Ljn2;

    invoke-interface {v5}, Ljn2;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Ljn2;)I
    ...
    invoke-static {v0, p2}, Lahd;->l(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {p1, v0, v1}, Ljn2;->d3(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lh23;
    ...
    .line 6
    invoke-interface {p1, v1, v2}, Ljn2;->b2(J)Lh23;
    ...
    invoke-virtual {p1}, Lh23;->u()Ljava/lang/String;
