...
.method public alternateService(ILjava/lang/String;Lh23;Ljava/lang/String;IJ)V
    .locals 0
...
.method public final applyAndAckSettings(ZLokhttp3/internal/http2/Settings;)V
    ...
    .line 14
    :goto_2
    iget-object v7, v0, Lvkl;->E0:Ljava/lang/Object;
    ...
    invoke-static {v8, v9}, Lahd;->l(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct {v9, v8, v10, v2, v0}, Lokhttp3/internal/http2/Http2Connection$ReaderRunnable$applyAndAckSettings$lambda-7$lambda-6$$inlined$execute$default$1;-><init>(Ljava/lang/String;ZLokhttp3/internal/http2/Http2Connection;Lvkl;)V
...
.method public data(ZILjn2;I)V
    ...
    invoke-virtual {v0, p2, p3, p4, p1}, Lokhttp3/internal/http2/Http2Connection;->pushDataLater$okhttp(ILjn2;IZ)V
    ...
    .line 6
    invoke-interface {p3, v0, v1}, Ljn2;->d3(J)V

    return-void

    .line 7
    :cond_1
    invoke-virtual {v0, p3, p4}, Lokhttp3/internal/http2/Http2Stream;->receiveData(Ljn2;I)V
...
.method public goAway(ILokhttp3/internal/http2/ErrorCode;Lh23;)V
    .locals 3
