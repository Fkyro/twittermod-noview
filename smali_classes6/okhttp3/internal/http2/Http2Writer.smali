...
.field private final hpackBuffer:Lpm2;
...
.method public constructor <init>(Lhn2;Z)V
    .locals 7
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lhn2;
    ...
    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lpm2;
...
.method private final writeContinuationFrames(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lhn2;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lpm2;

    invoke-interface {v0, v1, v2, v3}, Lmpp;->write(Lpm2;J)V
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lhn2;
...
.method public final declared-synchronized connectionPreface()V
    ...
    .line 4
    sget-object v2, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lh23;

    invoke-virtual {v2}, Lh23;->i()Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lh23;

    invoke-interface {v0, v1}, Lhn2;->F1(Lh23;)Lhn2;
...
.method public final declared-synchronized data(ZILpm2;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 2
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILpm2;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILpm2;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, p3, v0, v1}, Lmpp;->write(Lpm2;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lhn2;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lhn2;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Lhn2;->t2(I)Lhn2;
    ...
    invoke-interface {p2, p1}, Lhn2;->q0(I)Lhn2;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lhn2;->q0(I)Lhn2;
    ...
    invoke-interface {p1, p2}, Lhn2;->q0(I)Lhn2;
    ...
    invoke-interface {p1, p3}, Lhn2;->v1([B)Lhn2;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lpm2;

    .line 4
    iget-wide v0, p3, Lpm2;->F0:J
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lpm2;

    invoke-interface {p1, v4, v2, v3}, Lmpp;->write(Lpm2;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lhn2;->q0(I)Lhn2;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 7
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lhn2;

    const v3, 0x7fffffff

    and-int/2addr p2, v3

    invoke-interface {v2, p2}, Lhn2;->q0(I)Lhn2;

    .line 8
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lhn2;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lpm2;

    invoke-interface {p2, v2, v4, v5}, Lmpp;->write(Lpm2;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 5
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lhn2;

    invoke-interface {v4, v3}, Lhn2;->i2(I)Lhn2;

    .line 6
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lhn2;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v2

    invoke-interface {v3, v2}, Lhn2;->q0(I)Lhn2;
