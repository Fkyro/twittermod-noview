...
.field public static volatile c:Lvc6;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lvc6;->b:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lvc6;->a:Lj$/util/concurrent/ConcurrentHashMap;

    return-void
.end method

.method public static b()Lvc6;
    .locals 2

    .line 1
    sget-object v0, Lvc6;->c:Lvc6;

    if-nez v0, :cond_1

    sget-object v0, Lvc6;->b:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lvc6;->c:Lvc6;

    if-nez v1, :cond_0

    new-instance v1, Lvc6;

    invoke-direct {v1}, Lvc6;-><init>()V

    sput-object v1, Lvc6;->c:Lvc6;
...
.method public final a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    .line 2
    invoke-virtual/range {v1 .. v7}, Lvc6;->d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
...
.method public final c(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 2
    iget-object v0, p0, Lvc6;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    .line 5
    :catch_0
    iget-object p1, p0, Lvc6;->a:Lj$/util/concurrent/ConcurrentHashMap;
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    invoke-virtual {v3, v0, v2}, Lz3j;->a(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p6}, Lvc6;->e(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 15
    iget-object p2, p0, Lvc6;->a:Lj$/util/concurrent/ConcurrentHashMap;
