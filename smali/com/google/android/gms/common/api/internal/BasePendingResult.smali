...
# static fields
.field public static final n:Lz0x;
...
.field private mResultGuardian:Lb1x;
    .annotation build Lcom/google/android/gms/common/annotation/KeepName;
    .end annotation
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lz0x;

    invoke-direct {v0}, Lz0x;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->n:Lz0x;
...
.method public constructor <init>(Lcom/google/android/gms/common/api/c;)V
    ...
    .line 9
    invoke-virtual {p1}, Lcom/google/android/gms/common/api/c;->f()Landroid/os/Looper;
...
.method public static k(La6m;)V
    .locals 2

    .line 1
    instance-of v0, p0, Lzol;
    ...
    invoke-interface {v0}, Lzol;->release()V
    :try_end_0
...
.method public final b(Lmej$a;)V
    .locals 2
    ...
    .line 3
    invoke-interface {p1, v1}, Lmej$a;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final c()V
    ...
    .line 2
    :cond_0
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:La6m;

    .line 3
    invoke-static {v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->k(La6m;)V
    ...
    .line 4
    sget-object v1, Lcom/google/android/gms/common/api/Status;->N0:Lcom/google/android/gms/common/api/Status;

    invoke-virtual {p0, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->d(Lcom/google/android/gms/common/api/Status;)La6m;

    move-result-object v1

    invoke-virtual {p0, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->i(La6m;)V
...
.method public abstract d(Lcom/google/android/gms/common/api/Status;)La6m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final g(La6m;)V
    ...
    .line 4
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->i(La6m;)V
    ...
    .line 6
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->k(La6m;)V
...
.method public final h()La6m;
    ...
    invoke-static {v1, v3}, Lf7k;->m(ZLjava/lang/Object;)V
    ...
    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:La6m;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lb6m;
...
.method public final i(La6m;)V
    .locals 4

    .line 1
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:La6m;

    invoke-interface {p1}, La6m;->g()Lcom/google/android/gms/common/api/Status;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lb6m;

    goto :goto_0

    .line 3
    :cond_0
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lb6m;

    if-nez p1, :cond_1

    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:La6m;

    .line 4
    instance-of p1, p1, Lzol;

    if-eqz p1, :cond_2

    new-instance p1, Lb1x;

    invoke-direct {p1, p0}, Lb1x;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;)V

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->mResultGuardian:Lb1x;
    ...
    .line 6
    invoke-virtual {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h()La6m;

    move-result-object v1

    invoke-virtual {v0, p1, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult$a;->a(Lb6m;La6m;)V
    ...
    .line 9
    invoke-interface {v2, v3}, Lmej$a;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final j()V
    ...
    sget-object v0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->n:Lz0x;
