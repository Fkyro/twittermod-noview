...
.method public d(Landroid/view/View;Lwh;)V
    ...
    .line 14
    iget-boolean v8, v8, Lcom/google/android/material/textfield/TextInputLayout;->c2:Z
    ...
    .line 19
    iget-object v7, v7, Lcom/google/android/material/textfield/TextInputLayout;->F0:Lqhq;

    .line 20
    iget-object v11, v7, Lqhq;->F0:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    .line 22
    iget-object v12, p2, Lwh;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    invoke-virtual {v12, v11}, Landroid/view/accessibility/AccessibilityNodeInfo;->setLabelFor(Landroid/view/View;)V

    .line 23
    iget-object v7, v7, Lqhq;->F0:Landroidx/appcompat/widget/AppCompatTextView;

    invoke-virtual {p2, v7}, Lwh;->a0(Landroid/view/View;)V

    goto :goto_4

    .line 24
    :cond_4
    iget-object v7, v7, Lqhq;->H0:Lcom/google/android/material/internal/CheckableImageButton;
    ...
    .line 27
    invoke-virtual {p2, v0}, Lwh;->Z(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v2}, Lwh;->Z(Ljava/lang/CharSequence;)V
    ...
    .line 32
    invoke-virtual {p2, v0}, Lwh;->O(Ljava/lang/CharSequence;)V
    ...
    .line 35
    invoke-virtual {p2, v0}, Lwh;->X(Z)V
    ...
    .line 37
    :goto_7
    iget-object p1, p2, Lwh;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    .line 40
    iget-object p1, p1, Lcom/google/android/material/textfield/TextInputLayout;->O0:Ls2d;

    .line 41
    iget-object p1, p1, Ls2d;->r:Landroidx/appcompat/widget/AppCompatTextView;
