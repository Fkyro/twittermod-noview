...
.method public static declared-synchronized a()Ljava/lang/ClassLoader;
    ...
    :try_start_0
    sget-object v1, Lsdx;->a:Ljava/lang/ClassLoader;

    if-nez v1, :cond_0

    invoke-static {}, Lsdx;->b()Ljava/lang/ClassLoader;

    move-result-object v1

    sput-object v1, Lsdx;->a:Ljava/lang/ClassLoader;
...
.method public static declared-synchronized b()Ljava/lang/ClassLoader;
    ...
    .line 1
    :try_start_0
    sget-object v1, Lsdx;->b:Ljava/lang/Thread;

    const/4 v2, 0x0

    if-nez v1, :cond_1

    invoke-static {}, Lsdx;->c()Ljava/lang/Thread;

    move-result-object v1

    sput-object v1, Lsdx;->b:Ljava/lang/Thread;
    ...
    :try_start_2
    sget-object v3, Lsdx;->b:Ljava/lang/Thread;
...
.method public static declared-synchronized c()Ljava/lang/Thread;
    ...
    .line 11
    invoke-direct {v1, v8}, Lj5x;-><init>(Ljava/lang/ThreadGroup;)V
    :try_end_3
