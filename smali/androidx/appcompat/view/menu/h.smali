...
.method public final a()Lilg;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/view/menu/h;->j:Lilg;
    ...
    invoke-virtual {v0, v1}, Lilg;->i(Landroidx/appcompat/view/menu/e;)V

    .line 11
    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->l:Landroidx/appcompat/view/menu/h$a;

    invoke-virtual {v0, v1}, Lilg;->p(Landroid/widget/PopupWindow$OnDismissListener;)V

    .line 12
    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Lilg;->k(Landroid/view/View;)V

    .line 13
    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->i:Landroidx/appcompat/view/menu/i$a;

    invoke-interface {v0, v1}, Landroidx/appcompat/view/menu/i;->b(Landroidx/appcompat/view/menu/i$a;)V
    ...
    invoke-virtual {v0, v1}, Lilg;->n(I)V

    .line 16
    iput-object v0, p0, Landroidx/appcompat/view/menu/h;->j:Lilg;
...
.method public final d(Landroidx/appcompat/view/menu/i$a;)V
    ...
    .line 3
    invoke-interface {v0, p1}, Landroidx/appcompat/view/menu/i;->b(Landroidx/appcompat/view/menu/i$a;)V
...
.method public final f(IIZZ)V
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/appcompat/view/menu/h;->a()Lilg;

    move-result-object v0

    .line 2
    invoke-virtual {v0, p4}, Lilg;->q(Z)V
    ...
    .line 5
    invoke-static {p4}, Lb2w$e;->d(Landroid/view/View;)I
    ...
    .line 8
    :cond_0
    invoke-virtual {v0, p1}, Lilg;->o(I)V

    .line 9
    invoke-virtual {v0, p2}, Lilg;->r(I)V
    ...
    .line 12
    iput-object p4, v0, Lilg;->E0:Landroid/graphics/Rect;

    .line 13
    :cond_1
    invoke-interface {v0}, Lcip;->show()V
