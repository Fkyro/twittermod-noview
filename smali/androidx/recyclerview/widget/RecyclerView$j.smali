...
.method public static e(Landroidx/recyclerview/widget/RecyclerView$c0;)I
    ...
    .line 3
    iget v1, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->H0:I
...
.method public final h(Landroidx/recyclerview/widget/RecyclerView$c0;)V
    ...
    .line 4
    iget-object v2, p1, Landroidx/recyclerview/widget/RecyclerView$c0;->L0:Landroidx/recyclerview/widget/RecyclerView$c0;

    const/4 v3, 0x0

    if-eqz v2, :cond_0

    iget-object v2, p1, Landroidx/recyclerview/widget/RecyclerView$c0;->M0:Landroidx/recyclerview/widget/RecyclerView$c0;

    if-nez v2, :cond_0

    .line 5
    iput-object v3, p1, Landroidx/recyclerview/widget/RecyclerView$c0;->L0:Landroidx/recyclerview/widget/RecyclerView$c0;

    .line 6
    :cond_0
    iput-object v3, p1, Landroidx/recyclerview/widget/RecyclerView$c0;->M0:Landroidx/recyclerview/widget/RecyclerView$c0;

    .line 7
    iget v2, p1, Landroidx/recyclerview/widget/RecyclerView$c0;->N0:I
    ...
    .line 9
    invoke-virtual {v2}, Landroidx/recyclerview/widget/RecyclerView;->A0()V

    .line 10
    iget-object v5, v2, Landroidx/recyclerview/widget/RecyclerView;->I0:Landroidx/recyclerview/widget/f;

    .line 11
    iget-object v6, v5, Landroidx/recyclerview/widget/f;->a:Landroidx/recyclerview/widget/f$b;

    check-cast v6, Landroidx/recyclerview/widget/c0;

    invoke-virtual {v6, v4}, Landroidx/recyclerview/widget/c0;->c(Landroid/view/View;)I
    ...
    .line 12
    invoke-virtual {v5, v4}, Landroidx/recyclerview/widget/f;->m(Landroid/view/View;)Z

    goto :goto_1

    .line 13
    :cond_2
    iget-object v7, v5, Landroidx/recyclerview/widget/f;->b:Landroidx/recyclerview/widget/f$a;

    invoke-virtual {v7, v6}, Landroidx/recyclerview/widget/f$a;->d(I)Z
    ...
    invoke-virtual {v7, v6}, Landroidx/recyclerview/widget/f$a;->f(I)Z

    .line 15
    invoke-virtual {v5, v4}, Landroidx/recyclerview/widget/f;->m(Landroid/view/View;)Z

    .line 16
    iget-object v5, v5, Landroidx/recyclerview/widget/f;->a:Landroidx/recyclerview/widget/f$b;

    check-cast v5, Landroidx/recyclerview/widget/c0;

    invoke-virtual {v5, v6}, Landroidx/recyclerview/widget/c0;->d(I)V
    ...
    .line 17
    invoke-static {v4}, Landroidx/recyclerview/widget/RecyclerView;->R(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$c0;

    move-result-object v4

    .line 18
    iget-object v5, v2, Landroidx/recyclerview/widget/RecyclerView;->F0:Landroidx/recyclerview/widget/RecyclerView$t;

    invoke-virtual {v5, v4}, Landroidx/recyclerview/widget/RecyclerView$t;->n(Landroidx/recyclerview/widget/RecyclerView$c0;)V
    ...
    .line 20
    invoke-virtual {v2, v4}, Landroidx/recyclerview/widget/RecyclerView;->C0(Z)V
