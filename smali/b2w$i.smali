...
.method public static b(Landroid/view/View;Lwkw;Landroid/graphics/Rect;)Lwkw;
    .locals 1
...
.method public static j(Landroid/view/View;)Lwkw;
    .locals 5

    .line 1
    sget-boolean v0, Lwkw$a;->d:Z
    ...
    .line 3
    :try_start_0
    sget-object v2, Lwkw$a;->a:Ljava/lang/reflect/Field;
    ...
    .line 4
    sget-object v2, Lwkw$a;->b:Ljava/lang/reflect/Field;
    ...
    .line 5
    sget-object v3, Lwkw$a;->c:Ljava/lang/reflect/Field;
    ...
    .line 7
    new-instance v3, Lwkw$d;

    invoke-direct {v3}, Lwkw$d;-><init>()V
    ...
    .line 8
    new-instance v3, Lwkw$c;

    invoke-direct {v3}, Lwkw$c;-><init>()V

    goto :goto_0

    .line 9
    :cond_2
    new-instance v3, Lwkw$b;

    invoke-direct {v3}, Lwkw$b;-><init>()V

    .line 10
    :goto_0
    invoke-static {v2}, Lv9d;->c(Landroid/graphics/Rect;)Lv9d;

    move-result-object v2

    .line 11
    invoke-virtual {v3, v2}, Lwkw$e;->e(Lv9d;)V

    .line 12
    invoke-static {v0}, Lv9d;->c(Landroid/graphics/Rect;)Lv9d;

    move-result-object v0

    .line 13
    invoke-virtual {v3, v0}, Lwkw$e;->g(Lv9d;)V

    .line 14
    invoke-virtual {v3}, Lwkw$e;->b()Lwkw;

    move-result-object v0

    .line 15
    invoke-virtual {v0, v0}, Lwkw;->m(Lwkw;)V
...
.method public static u(Landroid/view/View;Lqui;)V
    .locals 2
    ...
    .line 5
    :cond_1
    new-instance v0, Lb2w$i$a;

    invoke-direct {v0, p0, p1}, Lb2w$i$a;-><init>(Landroid/view/View;Lqui;)V
