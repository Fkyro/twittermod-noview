...
# instance fields
.field public final G0:Lbtd;


# direct methods
.method public constructor <init>(Lk16;Lbtd;)V
    .locals 1
    ...
    .line 2
    iput-object p2, p0, Lwsd;->G0:Lbtd;
...
.method public final b(Lt16;I)V
    ...
    .line 10
    iget-object v1, p0, Lwsd;->G0:Lbtd;
    ...
    .line 11
    new-instance v2, Lwsd$a;

    invoke-direct {v2, v1}, Lwsd$a;-><init>(Ljava/lang/Object;)V
    ...
    .line 22
    new-instance v3, Lwsd$b;

    const/4 v4, 0x0

    invoke-direct {v3, v0, v1, v2, v4}, Lwsd$b;-><init>(Lcom/twitter/weaver/mvi/MviViewModel;Lks6;Lmiq;Lgk6;)V
    ...
    .line 25
    invoke-static {v0, v4, p1, v1, v2}, Lysd;->b(Lcom/twitter/communities/bottomsheet/reply/JoinToReplyBottomSheetViewModel;Lgzg;Lt16;II)V
    ...
    :cond_1
    new-instance v0, Lwsd$c;

    invoke-direct {v0, p0, p2}, Lwsd$c;-><init>(Lwsd;I)V
