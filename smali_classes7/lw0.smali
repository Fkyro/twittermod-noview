...
.method public constructor <init>(Li0t;Lh0t;)V
    ...
    const-string p2, "audio decoder: created in thread "
...
.method public final f(Li0t;Landroid/view/Surface;Li8g$a;)V
    ...
    const-string v5, "Try audio decoder configuration with "
    ...
    invoke-virtual {p3, p1, v2, v2, p2}, Landroid/media/MediaCodec;->configure(Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;I)V
    ...
    const-string v2, "Audio decoder configured with "
    ...
    const-string p3, "Audio decoder already initialized"
    ...
    :goto_0
    const-string p2, "Invalid audio decoder setting: Recoverable "
    ...
    const-string p3, "Error while configuring audio decoder"
    ...
    const-string p2, "Error while configuring audio decoder: Surface must be null for audio decoder"
