...
.method public static constructor <clinit>()V
    ...
    .line 2
    sput-object v0, Liuw;->n:Lyvc$b;

    const-string v2, "_id"

    const-string v3, "tokens_text"

    const-string v4, "tokens_weight"

    const-string v5, "tokens_type"

    const-string v6, "tokens_ref_id"

    const-string v7, "tokens_result_context"

    const-string v8, "users__id"

    const-string v9, "users_user_id"

    const-string v10, "users_username"

    const-string v11, "users_name"

    const-string v12, "users_image_url"

    const-string v13, "users_user_flags"

    const-string v14, "users_is_profile_translatable"

    const-string v15, "users_friendship"

    const-string v16, "users_friendship_time"

    const-string v17, "users_are_dms_muted"

    const-string v18, "users_is_active_creator"

    const-string v19, "users_profile_image_colors"

    const-string v20, "users_has_nft_avatar"

    const-string v21, "users_is_blue_verified"

    const-string v22, "users_user_label_data"

    const-string v23, "users_verified_type"

    const-string v24, "users_super_followers_count"

    const-string v25, "users_blob_data"

    const-string v26, "users_has_twitter_articles"

    const-string v27, "users_verified_phone_status"

    const-string v28, "users_is_graduated"

    const-string v29, "users_header_url"

    const-string v30, "users_description"

    const-string v31, "users_link_color"

    const-string v32, "users_web_url"

    const-string v33, "users_url_entities"

    const-string v34, "users_bg_color"

    const-string v35, "users_extended_profile_fields"

    const-string v36, "users_location"

    const-string v37, "users_structured_location"

    const-string v38, "users_followers"

    const-string v39, "users_fast_followers"

    const-string v40, "users_friends"

    const-string v41, "users_statuses"

    const-string v42, "users_favorites"

    const-string v43, "users_media_count"

    const-string v44, "users_profile_created"

    const-string v45, "users_updated"

    const-string v46, "users_pinned_tweet_id"

    const-string v47, "users_advertiser_type"

    const-string v48, "users_hash"

    const-string v49, "users_translator_type"

    const-string v50, "users_profile_interstitial_type"

    const-string v51, "users_profile_banner_colors"

    const-string v52, "users_withheld_info"

    const-string v53, "users_tip_jar_settings"

    const-string v54, "users_smart_blocking_expiration"

    const-string v55, "users_professional"

    const-string v56, "user_metadata__id"

    const-string v57, "user_metadata_owner_id"

    const-string v58, "user_metadata_user_id"

    const-string v59, "user_metadata_user_group_type"

    const-string v60, "user_metadata_user_group_tag"

    const-string v61, "user_metadata_token"
    ...
    sput-object v0, Liuw;->o:[Ljava/lang/String;
...
.method public constructor <init>(Ls7o;)V
    ...
    .line 2
    new-instance v0, Liuw$b;

    invoke-direct {v0, p0, p1}, Liuw$b;-><init>(Liuw;Ls7o;)V

    iput-object v0, p0, Liuw;->m:Liuw$b;
...
.method public final b()Lnyp;
    ...
    iget-object v0, p0, Liuw;->m:Liuw$b;
