...
.method constructor <init>(Lj$/util/stream/c;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/h3;->j(II)I
...
.method private E1(I)Lj$/util/Spliterator;
    .locals 7
    ...
    invoke-virtual {v2}, Lj$/util/stream/c;->C1()Z
    ...
    invoke-virtual {v5, v4}, Lj$/util/stream/h3;->z(I)Z

    move-result v5

    if-eqz v5, :cond_0

    sget v5, Lj$/util/stream/h3;->u:I
    ...
    :cond_0
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/c;->B1(Lj$/util/stream/G0;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    sget v5, Lj$/util/stream/h3;->t:I

    not-int v5, v5

    and-int/2addr v4, v5

    sget v5, Lj$/util/stream/h3;->s:I
    ...
    invoke-static {v4, v0}, Lj$/util/stream/h3;->j(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/h3;->j(II)I
...
# virtual methods
.method A1(Lj$/util/stream/G0;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/S0;
    .locals 0
...
.method B1(Lj$/util/stream/G0;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    .locals 1

    sget-object v0, Lj$/util/stream/a;->a:Lj$/util/stream/a;

    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/c;->A1(Lj$/util/stream/G0;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/S0;

    move-result-object p1

    invoke-interface {p1}, Lj$/util/stream/S0;->spliterator()Lj$/util/Spliterator;
...
.method abstract D1(ILj$/util/stream/t2;)Lj$/util/stream/t2;
.end method

.method final F1()Lj$/util/Spliterator;
    .locals 3
...
.method abstract G1(Lj$/util/stream/G0;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
.end method

.method final N0(Lj$/util/stream/t2;Lj$/util/Spliterator;)V
    .locals 2
    ...
    invoke-interface {p1, v0, v1}, Lj$/util/stream/t2;->q(J)V

    invoke-interface {p2, p1}, Lj$/util/Spliterator;->forEachRemaining(Lj$/util/function/Consumer;)V

    invoke-interface {p1}, Lj$/util/stream/t2;->p()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/c;->O0(Lj$/util/stream/t2;Lj$/util/Spliterator;)V

    :goto_0
    return-void
.end method

.method final O0(Lj$/util/stream/t2;Lj$/util/Spliterator;)V
    .locals 3
    ...
    invoke-interface {p1, v1, v2}, Lj$/util/stream/t2;->q(J)V

    invoke-virtual {v0, p2, p1}, Lj$/util/stream/c;->w1(Lj$/util/Spliterator;Lj$/util/stream/t2;)V
...
.method final S0(Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/S0;
    .locals 2
    ...
    .line 2
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/c;->v1(Lj$/util/stream/G0;Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/S0;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lj$/util/stream/c;->T0(Lj$/util/Spliterator;)J

    move-result-wide v0

    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/G0;->l1(JLj$/util/function/IntFunction;)Lj$/util/stream/K0;

    move-result-object p2

    invoke-virtual {p0, p2, p1}, Lj$/util/stream/c;->q1(Lj$/util/stream/t2;Lj$/util/Spliterator;)Lj$/util/stream/t2;
...
.method final T0(Lj$/util/Spliterator;)J
    .locals 2
...
.method final Z0()I
    ...
    :cond_0
    invoke-virtual {v0}, Lj$/util/stream/c;->x1()I
...
.method public final onClose(Ljava/lang/Runnable;)Lj$/util/stream/i;
    ...
    invoke-direct {v2, v1, p1, v3}, Lj$/util/stream/N3;-><init>(Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method final q1(Lj$/util/stream/t2;Lj$/util/Spliterator;)Lj$/util/stream/t2;
    .locals 1
    ...
    .line 2
    invoke-virtual {p0, p1}, Lj$/util/stream/c;->r1(Lj$/util/stream/t2;)Lj$/util/stream/t2;

    move-result-object v0

    invoke-virtual {p0, v0, p2}, Lj$/util/stream/c;->N0(Lj$/util/stream/t2;Lj$/util/Spliterator;)V

    return-object p1
.end method

.method final r1(Lj$/util/stream/t2;)Lj$/util/stream/t2;
    .locals 2
    ...
    invoke-virtual {v0, v1, p1}, Lj$/util/stream/c;->D1(ILj$/util/stream/t2;)Lj$/util/stream/t2;
...
.method final s1(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    .locals 2
    ...
    .line 2
    invoke-virtual {p0, p0, v0, p1}, Lj$/util/stream/c;->G1(Lj$/util/stream/G0;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
...
.method public spliterator()Lj$/util/Spliterator;
    ...
    .line 2
    invoke-virtual {p0, p0, v2, v0}, Lj$/util/stream/c;->G1(Lj$/util/stream/G0;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
...
.method final t1(Lj$/util/stream/Q3;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-direct {p0, v0}, Lj$/util/stream/c;->E1(I)Lj$/util/Spliterator;

    move-result-object v0

    invoke-interface {p1, p0, v0}, Lj$/util/stream/Q3;->c(Lj$/util/stream/G0;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/Q3;->d(Lj$/util/stream/G0;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method final u1(Lj$/util/function/IntFunction;)Lj$/util/stream/S0;
    .locals 3
    ...
    invoke-direct {v0, v2}, Lj$/util/stream/c;->E1(I)Lj$/util/Spliterator;

    move-result-object v1

    invoke-virtual {p0, v0, v1, p1}, Lj$/util/stream/c;->A1(Lj$/util/stream/G0;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/S0;
    ...
    :cond_0
    invoke-direct {p0, v2}, Lj$/util/stream/c;->E1(I)Lj$/util/Spliterator;

    move-result-object v1

    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/c;->S0(Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/S0;
...
.method abstract v1(Lj$/util/stream/G0;Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/S0;
.end method

.method abstract w1(Lj$/util/Spliterator;Lj$/util/stream/t2;)V
.end method

.method abstract x1()I
.end method
...
.method final synthetic z1()Lj$/util/Spliterator;
    .locals 1
