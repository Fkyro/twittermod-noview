...
.method public static synthetic e0(Lj$/util/stream/x0;)Ljava/util/stream/LongStream;
    .locals 1
...
.method public final synthetic allMatch(Ljava/util/function/LongPredicate;)Z
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->X(Lj$/util/function/n0;)Z
...
.method public final synthetic anyMatch(Ljava/util/function/LongPredicate;)Z
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->U(Lj$/util/function/n0;)Z
...
.method public final synthetic asDoubleStream()Ljava/util/stream/DoubleStream;
    ...
    invoke-static {v0}, Lj$/util/stream/K;->e0(Lj$/util/stream/L;)Ljava/util/stream/DoubleStream;
...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/x0;->average()Lj$/util/i;
...
.method public final synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/ObjLongConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/x0;->V(Lj$/util/function/Supplier;Lj$/util/function/G0;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
...
.method public final synthetic distinct()Ljava/util/stream/LongStream;
    ...
    invoke-static {v0}, Lj$/util/stream/w0;->e0(Lj$/util/stream/x0;)Ljava/util/stream/LongStream;
...
.method public final synthetic filter(Ljava/util/function/LongPredicate;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->Y(Lj$/util/function/n0;)Lj$/util/stream/x0;

    move-result-object p1

    invoke-static {p1}, Lj$/util/stream/w0;->e0(Lj$/util/stream/x0;)Ljava/util/stream/LongStream;
...
.method public final synthetic findAny()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/x0;->findAny()Lj$/util/j;

    move-result-object v0

    invoke-static {v0}, Lj$/util/h;->h(Lj$/util/j;)Ljava/util/OptionalLong;
...
.method public final synthetic findFirst()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/x0;->findFirst()Lj$/util/j;
...
.method public final synthetic flatMap(Ljava/util/function/LongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->n(Lj$/util/function/k0;)Lj$/util/stream/x0;
...
.method public final synthetic forEach(Ljava/util/function/LongConsumer;)V
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->e(Lj$/util/function/h0;)V
...
.method public final synthetic forEachOrdered(Ljava/util/function/LongConsumer;)V
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->R(Lj$/util/function/h0;)V
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/x0;->iterator()Lj$/util/w;
...
.method public final synthetic map(Ljava/util/function/LongUnaryOperator;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->s(Lj$/util/function/x0;)Lj$/util/stream/x0;
...
.method public final synthetic mapToDouble(Ljava/util/function/LongToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->l(Lj$/util/function/q0;)Lj$/util/stream/L;

    move-result-object p1

    invoke-static {p1}, Lj$/util/stream/K;->e0(Lj$/util/stream/L;)Ljava/util/stream/DoubleStream;
...
.method public final synthetic mapToInt(Ljava/util/function/LongToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->I(Lj$/util/function/t0;)Lj$/util/stream/IntStream;
...
.method public final synthetic mapToObj(Ljava/util/function/LongFunction;)Ljava/util/stream/Stream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->J(Lj$/util/function/k0;)Lj$/util/stream/Stream;
...
.method public final synthetic max()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/x0;->max()Lj$/util/j;
...
.method public final synthetic min()Ljava/util/OptionalLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/x0;->min()Lj$/util/j;
...
.method public final synthetic noneMatch(Ljava/util/function/LongPredicate;)Z
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->b(Lj$/util/function/n0;)Z
...
.method public final synthetic onClose(Ljava/lang/Runnable;)Ljava/util/stream/BaseStream;
    ...
    invoke-static {p1}, Lj$/util/stream/h;->e0(Lj$/util/stream/i;)Ljava/util/stream/BaseStream;
...
.method public final synthetic parallel()Ljava/util/stream/BaseStream;
    ...
    invoke-static {v0}, Lj$/util/stream/h;->e0(Lj$/util/stream/i;)Ljava/util/stream/BaseStream;
...
.method public final synthetic peek(Ljava/util/function/LongConsumer;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->m(Lj$/util/function/h0;)Lj$/util/stream/x0;
...
.method public final synthetic reduce(JLjava/util/function/LongBinaryOperator;)J
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/x0;->v(JLj$/util/function/d0;)J
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Ljava/util/OptionalLong;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/x0;->h(Lj$/util/function/d0;)Lj$/util/j;

    move-result-object p1

    invoke-static {p1}, Lj$/util/h;->h(Lj$/util/j;)Ljava/util/OptionalLong;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfLong;
    ...
    invoke-interface {v0}, Lj$/util/stream/x0;->spliterator()Lj$/util/H;

    move-result-object v0

    invoke-static {v0}, Lj$/util/G;->a(Lj$/util/H;)Ljava/util/Spliterator$OfLong;
...
.method public final summaryStatistics()Ljava/util/LongSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/x0;->summaryStatistics()Lj$/util/g;
