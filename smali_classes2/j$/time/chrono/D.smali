...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v3, v1, v4}, Lj$/time/chrono/D;-><init>(ILj$/time/LocalDate;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v4, v3, v5}, Lj$/time/chrono/D;-><init>(ILj$/time/LocalDate;Ljava/lang/String;)V
    ...
    invoke-static {v5, v6, v7}, Lj$/time/LocalDate;->b0(III)Lj$/time/LocalDate;

    move-result-object v5

    const-string v6, "Showa"

    invoke-direct {v3, v2, v5, v6}, Lj$/time/chrono/D;-><init>(ILj$/time/LocalDate;Ljava/lang/String;)V
    ...
    invoke-direct {v5, v7, v6, v8}, Lj$/time/chrono/D;-><init>(ILj$/time/LocalDate;Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v2}, Lj$/time/LocalDate;->b0(III)Lj$/time/LocalDate;
    ...
    invoke-direct {v6, v10, v8, v11}, Lj$/time/chrono/D;-><init>(ILj$/time/LocalDate;Ljava/lang/String;)V
...
.method private constructor <init>(ILj$/time/LocalDate;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lj$/time/chrono/D;->b:Lj$/time/LocalDate;
...
.method public static C()[Lj$/time/chrono/D;
    .locals 2
...
.method static k(Lj$/time/LocalDate;)Lj$/time/chrono/D;
    .locals 3

    sget-object v0, Lj$/time/chrono/C;->d:Lj$/time/LocalDate;

    invoke-virtual {p0, v0}, Lj$/time/LocalDate;->X(Lj$/time/chrono/f;)Z
    ...
    iget-object v2, v1, Lj$/time/chrono/D;->b:Lj$/time/LocalDate;

    invoke-virtual {p0, v2}, Lj$/time/LocalDate;->M(Lj$/time/chrono/f;)I
...
.method static n()Lj$/time/chrono/D;
    .locals 2
...
.method public static u(I)Lj$/time/chrono/D;
    .locals 3
...
.method static w()J
    ...
    invoke-virtual {v0}, Lj$/time/temporal/z;->f()J
    ...
    iget-object v6, v5, Lj$/time/chrono/D;->b:Lj$/time/LocalDate;

    invoke-virtual {v6}, Lj$/time/LocalDate;->L()I

    move-result v6

    iget-object v7, v5, Lj$/time/chrono/D;->b:Lj$/time/LocalDate;

    invoke-virtual {v7}, Lj$/time/LocalDate;->U()I
    ...
    invoke-virtual {v5}, Lj$/time/chrono/D;->q()Lj$/time/chrono/D;
    ...
    iget-object v5, v5, Lj$/time/chrono/D;->b:Lj$/time/LocalDate;

    invoke-virtual {v5}, Lj$/time/LocalDate;->U()I
...
.method static y()J
    ...
    iget-object v0, v0, Lj$/time/chrono/D;->b:Lj$/time/LocalDate;
    ...
    iget-object v2, v2, Lj$/time/chrono/D;->b:Lj$/time/LocalDate;
    ...
    iget-object v5, v4, Lj$/time/chrono/D;->b:Lj$/time/LocalDate;
    ...
    iget-object v2, v4, Lj$/time/chrono/D;->b:Lj$/time/LocalDate;
...
.method final o()Lj$/time/LocalDate;
    .locals 1

    iget-object v0, p0, Lj$/time/chrono/D;->b:Lj$/time/LocalDate;

    return-object v0
.end method

.method final q()Lj$/time/chrono/D;
    .locals 1
    ...
    invoke-static {v0}, Lj$/time/chrono/D;->u(I)Lj$/time/chrono/D;
...
.method public final r(Lj$/time/temporal/p;)Lj$/time/temporal/z;
    ...
    invoke-virtual {p1, v0}, Lj$/time/chrono/A;->I(Lj$/time/temporal/a;)Lj$/time/temporal/z;
