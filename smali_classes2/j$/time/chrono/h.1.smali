...
.method static C(Lj$/time/chrono/q;Lj$/time/temporal/k;)Lj$/time/chrono/f;
    .locals 2
...
# virtual methods
.method public A()Lj$/time/chrono/r;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lj$/time/chrono/q;->R(I)Lj$/time/chrono/r;
...
.method public F(Lj$/time/temporal/o;)Lj$/time/chrono/f;
    .locals 1
...
.method public G()Z
    ...
    invoke-interface {p0, v1}, Lj$/time/temporal/TemporalAccessor;->f(Lj$/time/temporal/p;)J

    move-result-wide v1

    invoke-interface {v0, v1, v2}, Lj$/time/chrono/q;->P(J)Z
...
.method public L()I
    ...
    invoke-interface {p0}, Lj$/time/chrono/f;->G()Z
...
.method public final synthetic M(Lj$/time/chrono/f;)I
    .locals 0
...
.method abstract N(J)Lj$/time/chrono/f;
.end method
...
.method public b(Lj$/time/temporal/l;)Lj$/time/chrono/f;
    .locals 1
...
.method public bridge synthetic b(Lj$/time/temporal/l;)Lj$/time/temporal/k;
    ...
    invoke-virtual {p0, p1}, Lj$/time/chrono/h;->b(Lj$/time/temporal/l;)Lj$/time/chrono/f;
...
.method public bridge synthetic c(Lj$/time/temporal/p;J)Lj$/time/temporal/k;
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/h;->c(Lj$/time/temporal/p;J)Lj$/time/chrono/f;
...
.method public final bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/chrono/h;->M(Lj$/time/chrono/f;)I
...
.method public g(JLj$/time/temporal/x;)Lj$/time/chrono/f;
    .locals 3
    ...
    invoke-interface {p0, p3}, Lj$/time/temporal/TemporalAccessor;->f(Lj$/time/temporal/p;)J
    ...
    invoke-virtual {p0, p3, p1, p2}, Lj$/time/chrono/h;->c(Lj$/time/temporal/p;J)Lj$/time/chrono/f;
    ...
    .line 8
    invoke-virtual {p0, p1, p2}, Lj$/time/chrono/h;->N(J)Lj$/time/chrono/f;
...
.method public bridge synthetic g(JLj$/time/temporal/x;)Lj$/time/temporal/k;
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/h;->g(JLj$/time/temporal/x;)Lj$/time/chrono/f;
...
.method public synthetic h(Lj$/time/temporal/p;)Z
    .locals 0
...
.method public hashCode()I
    ...
    invoke-virtual {p0}, Lj$/time/chrono/h;->v()J
...
.method public i(JLj$/time/temporal/x;)Lj$/time/chrono/f;
    .locals 1
...
.method public bridge synthetic i(JLj$/time/temporal/x;)Lj$/time/temporal/k;
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/h;->i(JLj$/time/temporal/x;)Lj$/time/chrono/f;
...
.method public synthetic r(Lj$/time/temporal/p;)Lj$/time/temporal/z;
    .locals 0
...
.method public toString()Ljava/lang/String;
    ...
    invoke-interface {p0, v2}, Lj$/time/temporal/TemporalAccessor;->f(Lj$/time/temporal/p;)J

    move-result-wide v2

    sget-object v4, Lj$/time/temporal/a;->DAY_OF_MONTH:Lj$/time/temporal/a;

    invoke-interface {p0, v4}, Lj$/time/temporal/TemporalAccessor;->f(Lj$/time/temporal/p;)J
    ...
    .line 1
    invoke-interface {v7}, Lj$/time/chrono/q;->o()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lj$/time/chrono/h;->A()Lj$/time/chrono/r;
...
.method public x(Lj$/time/l;)Lj$/time/chrono/i;
    .locals 0
