...
# direct methods
.method constructor <init>(Lj$/time/temporal/p;IIZ)V
    .locals 2
...
.method public final j(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v0}, Lj$/time/temporal/p;->r()Lj$/time/temporal/z;

    move-result-object v0

    iget-object v4, p0, Lj$/time/format/h;->a:Lj$/time/temporal/p;

    invoke-virtual {v0, v2, v3, v4}, Lj$/time/temporal/z;->b(JLj$/time/temporal/p;)J
...
.method public final r(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-interface {p3}, Lj$/time/temporal/p;->r()Lj$/time/temporal/z;
