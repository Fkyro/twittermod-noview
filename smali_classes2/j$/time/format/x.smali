...
# virtual methods
.method final a(Lj$/util/function/Consumer;)V
    .locals 1
...
.method final h()Lj$/time/chrono/q;
    .locals 1

    invoke-direct {p0}, Lj$/time/format/x;->e()Lj$/time/format/E;

    move-result-object v0

    iget-object v0, v0, Lj$/time/format/E;->c:Lj$/time/chrono/q;

    if-nez v0, :cond_0

    iget-object v0, p0, Lj$/time/format/x;->a:Lj$/time/format/DateTimeFormatter;

    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatter;->a()Lj$/time/chrono/q;
...
.method final j(Lj$/time/temporal/p;)Ljava/lang/Long;
    .locals 1
...
.method final r()V
    ...
    iget-object v3, v1, Lj$/time/format/E;->c:Lj$/time/chrono/q;

    iput-object v3, v2, Lj$/time/format/E;->c:Lj$/time/chrono/q;
...
.method final t(Lj$/time/format/F;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;
    ...
    invoke-virtual {p0}, Lj$/time/format/x;->h()Lj$/time/chrono/q;

    move-result-object v1

    iput-object v1, v0, Lj$/time/format/E;->c:Lj$/time/chrono/q;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/format/E;->n(Lj$/time/format/F;Ljava/util/Set;)Lj$/time/temporal/TemporalAccessor;
