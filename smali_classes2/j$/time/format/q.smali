...
.field private final h:Lj$/time/chrono/f;
...
.method private constructor <init>(Lj$/time/temporal/p;IIILj$/time/chrono/f;I)V
    .locals 6
    ...
    iput-object p5, p0, Lj$/time/format/q;->h:Lj$/time/chrono/f;

    return-void
.end method

.method synthetic constructor <init>(Lj$/time/temporal/p;IIILj$/time/chrono/f;ILj$/time/format/b;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lj$/time/format/q;-><init>(Lj$/time/temporal/p;IIILj$/time/chrono/f;I)V

    return-void
.end method

.method constructor <init>(Lj$/time/temporal/p;Lj$/time/chrono/f;)V
    .locals 7
...
.method final b(Lj$/time/format/z;J)J
    ...
    iget-object v3, p0, Lj$/time/format/q;->h:Lj$/time/chrono/f;
    ...
    iget-object v2, p0, Lj$/time/format/q;->h:Lj$/time/chrono/f;

    invoke-interface {p1, v2}, Lj$/time/chrono/q;->q(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/f;
...
.method final d(Lj$/time/format/x;JII)I
    ...
    iget-object v1, p0, Lj$/time/format/q;->h:Lj$/time/chrono/f;
    ...
    invoke-interface {v0, v1}, Lj$/time/chrono/q;->q(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/f;

    move-result-object v0

    iget-object v1, p0, Lj$/time/format/k;->a:Lj$/time/temporal/p;

    invoke-interface {v0, v1}, Lj$/time/temporal/TemporalAccessor;->j(Lj$/time/temporal/p;)I
...
.method final e()Lj$/time/format/k;
    ...
    iget-object v7, p0, Lj$/time/format/q;->h:Lj$/time/chrono/f;

    const/4 v8, -0x1

    move-object v2, v0

    invoke-direct/range {v2 .. v8}, Lj$/time/format/q;-><init>(Lj$/time/temporal/p;IIILj$/time/chrono/f;I)V
...
.method final f(I)Lj$/time/format/k;
    ...
    iget-object v5, p0, Lj$/time/format/q;->h:Lj$/time/chrono/f;
