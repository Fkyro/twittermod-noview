...
.method private b(Lj$/time/temporal/p;Ljava/util/Locale;)Ljava/lang/Object;
    ...
    .line 4
    :goto_4
    sget-object v2, Lj$/time/format/B;->a:Lj$/util/concurrent/ConcurrentHashMap;
...
# virtual methods
.method public d(Lj$/time/temporal/p;JLj$/time/format/H;Ljava/util/Locale;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1, p5}, Lj$/time/format/B;->b(Lj$/time/temporal/p;Ljava/util/Locale;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, p2, p3, p4}, Lj$/time/format/A;->a(JLj$/time/format/H;)Ljava/lang/String;
...
.method public e(Lj$/time/temporal/p;Lj$/time/format/H;Ljava/util/Locale;)Ljava/util/Iterator;
    .locals 0

    invoke-direct {p0, p1, p3}, Lj$/time/format/B;->b(Lj$/time/temporal/p;Ljava/util/Locale;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, p2}, Lj$/time/format/A;->b(Lj$/time/format/H;)Ljava/util/Iterator;
