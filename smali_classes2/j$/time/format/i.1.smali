...
.method public final j(Lj$/time/format/z;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v2, v1}, Lj$/time/format/z;->e(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    invoke-interface {v3, v4}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/p;)Z
    ...
    invoke-interface {v2, v4}, Lj$/time/temporal/TemporalAccessor;->f(Lj$/time/temporal/p;)J
    ...
    invoke-static {v5, v6, v7, v8}, Lj$/time/c;->f(JJ)J

    move-result-wide v9

    add-long/2addr v9, v11

    invoke-static {v5, v6, v7, v8}, Lj$/time/c;->d(JJ)J
    ...
    invoke-static {v5, v6, v3, v7}, Lj$/time/LocalDateTime;->c0(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    invoke-static {v7, v8, v3, v13}, Lj$/time/LocalDateTime;->c0(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
...
.method public final r(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v0, v1}, Lj$/time/format/w;->a(Lj$/time/format/DateTimeFormatter;)Lj$/time/format/w;
    ...
    invoke-virtual {v0, v4, v2}, Lj$/time/format/w;->o(Lj$/time/temporal/p;I)Lj$/time/format/w;
    ...
    invoke-virtual {v0, v7, v2, v5, v8}, Lj$/time/format/w;->b(Lj$/time/temporal/p;IIZ)Lj$/time/format/w;
    ...
    invoke-virtual {v0, v5, v9, v6}, Lj$/time/format/f;->r(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v5, v0}, Lj$/time/format/x;->j(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v1}, Lj$/time/format/x;->j(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v4}, Lj$/time/format/x;->j(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v3}, Lj$/time/format/x;->j(Lj$/time/temporal/p;)Ljava/lang/Long;

    move-result-object v3

    invoke-virtual {v5, v7}, Lj$/time/format/x;->j(Lj$/time/temporal/p;)Ljava/lang/Long;
    ...
    :try_start_0
    invoke-static/range {v12 .. v17}, Lj$/time/LocalDateTime;->a0(IIIIII)Lj$/time/LocalDateTime;

    move-result-object v0

    int-to-long v1, v2

    invoke-virtual {v0, v1, v2}, Lj$/time/LocalDateTime;->e0(J)Lj$/time/LocalDateTime;
    ...
    .line 1
    invoke-static {v0, v1}, Lj$/time/chrono/e;->p(Lj$/time/chrono/i;Lj$/time/ZoneOffset;)J
