...
.method private a(Lj$/time/LocalDateTime;Lj$/time/zone/b;)Ljava/lang/Object;
    .locals 2

    invoke-virtual {p2}, Lj$/time/zone/b;->r()Lj$/time/LocalDateTime;

    move-result-object v0

    invoke-virtual {p2}, Lj$/time/zone/b;->Q()Z

    move-result v1

    invoke-virtual {p1, v0}, Lj$/time/LocalDateTime;->X(Lj$/time/chrono/i;)Z
    ...
    :cond_0
    invoke-virtual {p2}, Lj$/time/zone/b;->j()Lj$/time/LocalDateTime;
...
.method private b(I)[Lj$/time/zone/b;
    ...
    invoke-static {v3}, Lj$/time/LocalDateTime;->Z(I)Lj$/time/LocalDateTime;
    ...
    .line 1
    invoke-static {v3, v4}, Lj$/time/chrono/e;->p(Lj$/time/chrono/i;Lj$/time/ZoneOffset;)J
    ...
    invoke-static {v6}, Lj$/time/zone/e;->k(I)Lj$/time/ZoneOffset;

    move-result-object v9

    invoke-direct {v0, v3, v4, v9}, Lj$/time/zone/e;->c(JLj$/time/ZoneOffset;)I
...
.method private c(JLj$/time/ZoneOffset;)I
    ...
    .line 1
    invoke-static {p1, p2, v0, v1}, Lj$/time/c;->f(JJ)J
...
.method private e(Lj$/time/LocalDateTime;)Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p1, v1}, Lj$/time/chrono/e;->p(Lj$/time/chrono/i;Lj$/time/ZoneOffset;)J
    ...
    invoke-direct {p0, p1, v1}, Lj$/time/zone/e;->a(Lj$/time/LocalDateTime;Lj$/time/zone/b;)Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lj$/time/zone/b;->N()Lj$/time/ZoneOffset;
    ...
    invoke-virtual {p1, v0}, Lj$/time/LocalDateTime;->W(Lj$/time/chrono/i;)Z
    ...
    invoke-virtual {v3}, Lj$/time/ZoneOffset;->X()I
...
.method private static k(I)Lj$/time/ZoneOffset;
    ...
    invoke-static {p0}, Lj$/time/ZoneOffset;->a0(I)Lj$/time/ZoneOffset;
...
.method static l(Ljava/io/DataInput;)Lj$/time/zone/e;
    .locals 8
...
.method public final d(Lj$/time/Instant;)Lj$/time/ZoneOffset;
    ...
    invoke-direct {p0, v2, v3, p1}, Lj$/time/zone/e;->c(JLj$/time/ZoneOffset;)I
    ...
    invoke-virtual {v0}, Lj$/time/zone/b;->S()J
    ...
    :cond_3
    invoke-virtual {v0}, Lj$/time/zone/b;->C()Lj$/time/ZoneOffset;
...
.method public final g(Lj$/time/LocalDateTime;)Ljava/util/List;
    ...
    invoke-virtual {p1}, Lj$/time/zone/b;->O()Ljava/util/List;
...
.method public final h(Lj$/time/Instant;)Z
    ...
    iget-object v2, p0, Lj$/time/zone/e;->a:[J
...
.method public final i()Z
    ...
    invoke-virtual {v1}, Lj$/time/Instant;->Q()J

    move-result-wide v10

    invoke-virtual {v1}, Lj$/time/Instant;->T()I
    ...
    invoke-direct {v0, v10, v11, v1}, Lj$/time/zone/e;->c(JLj$/time/ZoneOffset;)I
    ...
    invoke-virtual {v6}, Lj$/time/zone/b;->S()J
    ...
    invoke-static {}, Lj$/time/c;->j()Lj$/time/c;

    move-result-object v1

    invoke-virtual {v1}, Lj$/time/c;->h()J
    ...
    invoke-static {v4, v2, v2}, Lj$/time/LocalDate;->b0(III)Lj$/time/LocalDate;

    move-result-object v4

    invoke-virtual {v4}, Lj$/time/LocalDate;->v()J
    ...
    invoke-static {v4}, Lj$/time/zone/e;->k(I)Lj$/time/ZoneOffset;

    move-result-object v1

    invoke-direct {v0, v5, v6, v1}, Lj$/time/zone/e;->c(JLj$/time/ZoneOffset;)I
    ...
    invoke-virtual {v12}, Lj$/time/zone/b;->S()J
    ...
    :cond_d
    invoke-direct {v0, v4, v5, v1}, Lj$/time/zone/e;->c(JLj$/time/ZoneOffset;)I
...
.method public final toString()Ljava/lang/String;
    ...
    .line 4
    iget-object v2, p0, Lj$/time/zone/e;->b:[Lj$/time/ZoneOffset;
